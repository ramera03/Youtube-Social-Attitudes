...
- name: Reilly Amera
  ...
  - id: id1
    ...
    country: USA
    postal-code: 60637
abstract: "One way in which children learn about group dynamics within their racial world is from patterns in their daily environments. The current study seeks to understand the degree to which YouTube, a popular form of social media, exposes children to negatively valenced racial patterns, and potentially affects their beliefs. Dyads of parents and 8-13 year-old children (N = 18) describe daily YouTube usage, and the effects of children's YouTube usage are assessed. In the present sample, there is no relationship between children's YouTube usage, racial patterns they may observe, and negative racial beliefs."
floatsintext: true
...
# based on apaquarto manuscript example and chat help
...
# Returns string of format: "$F$(df, df.residual) = F-value, $p$ = p-value, $R^2$ = r-squared"
...
#| fig-scap: "Effects of time, daily use, and favorite YouTuber"
#| fig-note: "MrBeast is the modal favorite YouTuber. No other YouTuber has been listed with enough frequency to report."
#| fig-align: "center"
#| fig-width: 5
#| fig-height: 2
...
#| label: fig-faceted
#| fig-cap: "Correlation Between Racial Regularities Score and Malleability Score"
#| fig-scap: "Effects of daily use and participant race"
#| fig-note: "Participant race coded as White/Non-White for pilot data only."
#| fig-align: "center"
#| fig-width: 4
#| fig-height: 3
